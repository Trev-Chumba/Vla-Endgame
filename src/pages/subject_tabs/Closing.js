...
import {
    CardHeader, Grid, Card, Button, CardContent, Typography,
    Stack, TextField, Avatar, CardActions, TextareaAutosize
} from "@mui/material";
                                ...
                                <Stack spacing={3}>
                                    ...
                                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                                        <FormControl sx={{ m: 1, width: 1000 }}>
                                            <InputLabel id="findings-multiple-checkbox-label">Summary of Findings</InputLabel>
                                            <Select
                                    ...
                                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                                        ...
                                        <FormControl sx={{ m: 1, width: 1000 }}>
                                            <InputLabel id="reccomendations-multiple-checkbox-label">Reccommendations</InputLabel>
                                            <Select
