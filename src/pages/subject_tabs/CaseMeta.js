...
import { Grid, Card, Button, CardContent, Stack, TextField, Typography } from '@mui/material';
                ...
                <Stack spacing={3}>
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                    <FormControl sx={{ m: 1, width: 1100 }}>
                      <TextField fullWidth label="To" {...getFieldProps('source')} />
                    </FormControl>
                  </Stack>
                  ...
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                    <FormControl sx={{ m: 1, width: 1100 }}>
                      <TextField fullWidth label="From" {...getFieldProps('subject')} />
                    </FormControl>
                  </Stack>
