...
export default function AssociatesProfiles({ id, updateProfileData }) {
  ...
  const setAssociatesProfile = (values) => {
    FetchApi.post(
      associatesData.associate_ID ? UPDATE_ASSOCIATE_PROFILE : SET_ASSOCIATE_PROFILE,
      values,
      (status, data) => {
        if (status) {
          // setProfileData(data)
            ...
            <Grid container spacing={2} sx={{ width: '100%' }}>
              <Grid item md={12}>
                <Card sx={{ width: '100%', paddingBottom: 3 }}>
                  <CardHeader title="Associate Details" />
                </Card>
              </Grid>

              <Grid item md={12}>
                <Card sx={{ width: '100%', paddingBottom: 1 }}>
                  <CardHeader title="Add an Associate" />
                  <CardContent>
                    <Stack spacing={3}>
                      ...
                      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                        ...
                        {attachments ? (
                          ...
                          <Typography>{associatesData.attachments}</Typography>
                        )}
                      </Stack>
                      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                        <TextField
