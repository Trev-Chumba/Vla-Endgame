...
export default function DeclarationsProfile({ id, updateProfileData }) {
    ...
    const setSubjectResidence = (values) => {
        FetchApi.post(declarationsData.declarationID?UPDATE_DECLARATIONS:SET_DECLARATIONS, values, (status, data) => {
            if (status) {
                // setProfileData(data)
            ...
            <Container>
                <FormikProvider value={formik}>
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        ...
                        {
                          attachments ? <Typography>{attachments[0].name}</Typography> : <Typography>{declarationsData.attachments}</Typography>
                        }
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {filteredUsers
                                            ...
                                            .map((row) => {
                                                const { subjectID, attachments, estValue, type, declaration,
                                                    date, postalAddress, remarks, res_INFO_ID } = row;;
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="right">
                                                            <Button
                                                                onClick={() => setDeclarationsData(row)}>
