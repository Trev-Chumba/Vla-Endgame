      ...
      <FormikProvider value={formik}>
        <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            ...
            <Grid item md={12}>
              <Card sx={{ width: '100%', paddingBottom: 1 }}>
                ...
                <CardContent>
                  <Stack spacing={3}>
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                      <TextField fullWidth label="Nationality" {...getFieldProps('nationality')} />

                      <TextField fullWidth label="County" {...getFieldProps('county')} />

                      <TextField fullWidth label="Division" {...getFieldProps('division')} />

                      <TextField fullWidth label="Location" {...getFieldProps('location')} />
                    </Stack>
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                      ...
                      <TextField fullWidth label="KRA PIN" {...getFieldProps('kra_pin')} />

                      <TextField fullWidth label="Occupation" {...getFieldProps('occupation')} />
                ...
                <CardContent>
                  <Stack spacing={3}>
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                      ...
                      <TextField fullWidth label="Clan" {...getFieldProps('clan')} />
                    </Stack>
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                      ...
                      <TextField fullWidth label="Family" {...getFieldProps('family')} />
          ...
          >
            ...
            <DialogContent dividers>
              <h4>
                Do you want to Open a Preliminary Investigation? This action cannot be reversed.
              </h4>
            </DialogContent>
            <DialogActions>
