          ...
          <Grid container spacing={2} sx={{ width: '100%' }}>
            <Grid item md={12}>
              <Card sx={{ width: '100%', paddingBottom: 3 }}>
                <CardHeader title="Information from other Agencies" />
              </Card>
            </Grid>
          </Grid>
                ...
                <Stack spacing={3} sx={{ marginTop: 3 }}>
                  ...
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                    ...
                    {attachments ? (
                      ...
                      <Typography>{agencyData.attachments}</Typography>
                    )}
                  </Stack>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { arID, subjectID, agency, details, attachments, findings, remarks } =
                        row;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">
                            <Button onClick={() => setAgencyData(row)}>
